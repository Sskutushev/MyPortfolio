...
describe('Accessibility Tests', () => {
  ...
  it('Form inputs should have labels', async () => {
    ...
    expect(screen.getByText(/email или telegram|email or telegram/i)).toBeInTheDocument(); // Contact label
    expect(screen.getByText(/описание проекта|project description/i)).toBeInTheDocument(); // Message label
  });
});

...
color: #FFFFFF;
}`},metrics:{label:"Готовность",value:"100%",description:"Завершенное решение"}}];export{k as P,w as p,C as u};
